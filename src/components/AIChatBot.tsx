  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
        ...
        {isOpen && (
          ...
          >
            <Card className="h-full bg-white/10 backdrop-blur-2xl border-white/20 shadow-2xl flex flex-col overflow-hidden">
              {/* Header */}
              <div className="p-4 border-b border-white/10 bg-gradient-to-r from-orange-500/20 to-emerald-600/20">
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-3">
                    <motion.div
                      className="w-10 h-10 bg-gradient-to-r from-orange-500 to-emerald-600 rounded-full flex items-center justify-center"
                      animate={{ 
                        boxShadow: [
                ...
                <div className="flex gap-2">
                  ...
                  >
                    <Button
                      ...
                      className="bg-gradient-to-r from-orange-500 to-emerald-600 hover:from-orange-600 hover:to-emerald-700 text-white px-4 border-0"
                    >
      ...
      <motion.button
        ...
        className="w-14 h-14 bg-gradient-to-r from-orange-500 to-emerald-600 rounded-full shadow-2xl flex items-center justify-center text-white relative overflow-hidden"
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.9 }}
        animate={{
          boxShadow: [
      ...
      >
        {/* Gradient Animation */}
        <motion.div
          className="absolute inset-0 bg-gradient-to-r from-emerald-600 to-teal-600 opacity-0"
